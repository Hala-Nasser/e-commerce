    ...
    var default_options = {
        ...
        templateFile: '<div id="file-[INPUT_ID]-[FILE_NUM]" class="fileup-file [TYPE]">' +
                          ...
                          '<div class="data">' +
                              ...
                              '</div>' +
                              '<div class="controls">' +
                                  '<span class="remove" onclick="$.fileup(\'[INPUT_ID]\', \'remove\', \'[FILE_NUM]\');" title="[REMOVE]"><i class="fa fa-remove"></i> </span>' +
        ...
        onProgress: function(file_number, ProgressEvent, file) {
            if (event.lengthComputable) {
                ...
                $('#file-' + options.inputID + '-' + file_number + ' .fileup-progress-bar').css('width', percent + "%",'background-color','#e92246');
            }
        },
        ...
        onErrorSystem: function(event, file, file_number) {
            ...
            switch(event) {
                ...
                case 'error_load':
                    ...
                    $('.fileup-progress-bar').css('background-color','#e92246','width','80%');
                    break;
                case 'old_browser':
