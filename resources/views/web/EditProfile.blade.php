...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-md-8 col-lg-8 col-sm-6 col-xs-12">
                    ...
                    <div class="profile-content">
                        <div class="VideoDes">
                            <div class="box">
                                <input type="file" name="file5" id="file5" class="inputfile inputfile4" data-multiple-caption="{count} files selected" multiple="" onchange="readURL(this)">
                                <label for="file5"><i class="fa fa-plus" style="display: block;font-size: 20px;"></i><img  src="" alt="" id="imgPreview" class="responsive-img" > <span></span></label>
                            </div>
                                ...
                                <div class="thumbnail">
                                    ...
                                    <div class="edit">
                                        <div class="dropdown edit">
                                            ...
                                            <a class="dropdown-toggle" type="button" data-toggle="dropdown"><i class="fa fa-ellipsis-v"></i>
                                            </a>
    ...
    @section('script')
    <script type="text/javascript" src="{{asset('web/js/custom-file-input.js')}}"></script>
    @endsection