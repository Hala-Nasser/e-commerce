    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.categories.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('keywords_en') ? 'is-invalid' : '' }}" name="keywords_en" id="keywords_en">{!! old('keywords_en') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('keywords_ar') ? 'is-invalid' : '' }}" name="keywords_ar" id="keywords_ar">{!! old('keywords_ar') !!}</textarea>
