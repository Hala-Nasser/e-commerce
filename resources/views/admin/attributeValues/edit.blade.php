    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.attribute-values.update", [$attributeValue->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('value_en') ? 'is-invalid' : '' }}" type="text" name="value_en" id="value_en" value="{{ old('value_en', $attributeValue->value_en) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('value_ar') ? 'is-invalid' : '' }}" type="text" name="value_ar" id="value_ar" value="{{ old('value_ar', $attributeValue->value_ar) }}" required>
